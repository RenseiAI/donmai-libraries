...
```
npx @donmai/create-app [project-name] [options]
...
- [Getting Started](https://github.com/RenseiAI/donmai-libraries/blob/main/docs/getting-started.md)
- [Configuration Reference](https://github.com/RenseiAI/donmai-libraries/blob/main/docs/configuration.md)
- [Architecture](https://github.com/RenseiAI/donmai-libraries/blob/main/docs/architecture.md)
